...
clear all,clc
    ...
    generate_btn4 = uibutton(initial_panel, 'Text', 'Generate 4x4 game', ...
        'Position', [175 120 150 40], ...
        'ButtonPushedFcn', @(src,event) generateGame(4));
    
    generate_btn5 = uibutton(initial_panel, 'Text', 'Generate 5x5 game', ...
        'Position', [330 120 150 40], ...
        'ButtonPushedFcn', @(src,event) generateGame(5));
    
    generate_btn6 = uibutton(initial_panel, 'Text', 'Generate 6x6 game', ...
        'Position', [20 70 150 40], ...
        'ButtonPushedFcn', @(src,event) generateGame(6));
    
    generate_btn7 = uibutton(initial_panel, 'Text', 'Generate 7x7 game', ...
        'Position', [175 70 150 40], ...
        'ButtonPushedFcn', @(src,event) generateGame(7));
    
    generate_btn8 = uibutton(initial_panel, 'Text', 'Generate 8x8 game', ...
        'Position', [330 70 150 40], ...
        'ButtonPushedFcn', @(src,event) generateGame(8));
